...
// Profile
import CvIcon from '../assets/icons/cv-file-interface-symbol-svgrepo-com.svg';
import GithubIcon from '../assets/icons/github-svgrepo-com.svg';
import MailIcon from '../assets/icons/mail-plus-svgrepo-com.svg';

export {
    JavaIcon, JsIcon, KotlinIcon, RustIcon, PythonIcon,
    BootstrapIcon, AstroIcon,
    GitIcon, PostmanIcon,
    LinuxIcon, SqlIcon,
    CvIcon, GithubIcon, MailIcon
};
